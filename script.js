...
const locationlist = {
  ...
  "611": {
    ...
    "Materials": ["Gunner's Memory (Yellow)", "Mace Citrine", "Praying Angel Statue (Yellow)", "Knight's Memory (Yellow)", "Dagger Citrine", "Lightning Alcryst (Yellow)", "Winged One's Memory (Yellow)"]
    },
  "612": {
...
function bestLocation() {
  ...
  for (i = 0; i < 20; i++) {
    ...
    if (check == 0) {
      fulltable2 =
        "No best location found. All locations have 1 or fewer material per map.";
    } else {
      fulltable2 = `
